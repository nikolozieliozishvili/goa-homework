...
# "Anna" არის ცვლადისთვის მნიშვნელობა

surname= "eliozishvili"

print(name)
#პრინტ ფუნქციას გადაეცემა ეკრანზე გამოსატანი ობიექტი
name = "Nikolozi"  #ეს არის str (string) ტიპის ცვლადი
...
is_uglu = False  #snakecase (უბრალოდ წრის სტილი სტანდარტულად)
